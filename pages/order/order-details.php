                ...
                <div class="card">
                    <div class="card-body position-relative">
                        ...
                        <label for="payment_id" class="card-text d-block">
                            付款方式：
                            <select class="card-text border-0 rounded-2 text-dark bg-light p-2 ms-2" name="payment_id"
                                id="payment_method">
                                ...
                                <option value="3" <?php if ($value['o_payment'] == 3) echo 'selected'; ?>>Line Pay
                                </option>
                                <option value="4" <?php if ($value['o_payment'] == 4) echo 'selected'; ?>>Apple Pay
                                </option>
                                <option value="5" <?php if ($value['o_payment'] == 5) echo 'selected'; ?>>Google Pay
                                </option>
                                <option value="6" <?php if ($value['o_payment'] == 6) echo 'selected'; ?>>Paypal
                                </option>
                            </select>
                        ...
                        <label for="status_id">
                            訂單狀態：
                            <select class="card-text border-0 rounded-2 text-dark bg-light p-2 ms-2" name="status_id"
                                id="status_id">
                        ...
                        <div class="position-absolute bottom-10 end-5">
                            <a class="demo" data-bs-toggle="modal"
                                data-bs-target="<?= "#exampleModal" . $value['id'] ?>">修改</a>
                        </div>
                ...
                <div class="card">
                    <div class="card-body position-relative">
                        ...
                        <label for="message" class="card-text d-block">
                            商家備註：
                            <input type="text" id="message" class="card-text border-0 rounded-2 text-muted bg-light p-2"

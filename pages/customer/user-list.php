        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header d-flex p-3 pt-2">
                    <div class="d-flex align-items-center align-content-center bg-gradient-primary shadow-info text-center border-radius-xl mt-n4">
                        <p class="h3 text-white px-4 py-3">會員管理</p>
                    </div>
                </div>
            ...
            <button class="nav-link" id="nav-customer-tab" data-bs-toggle="tab" data-bs-target="#nav-customer" type="button" role="tab" aria-controls="nav-customer" aria-selected="false">非會員</button> -->
                        ...
                        <!--            <a type="button" href="user-list.php?table=member" style="cursor: pointer;" class="nav-link --><?php //if ($_GET['table'] == 'member') echo 'active'; 
                                                                                                                                        ?>
                        <!--">會員</a>-->
                        <!--            <a href="user-list.php?table=customer" style="cursor: pointer;" class="nav-link --><?php //if ($_GET['table'] == 'customer') echo 'active'; 
                                                                                                                            ?>
                        <!--">非會員</a>-->
                    </div>

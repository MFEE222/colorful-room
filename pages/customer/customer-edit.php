            ...
            ?>
                ...
                <form action="customerDoUpdate.php" method="post">
                    ...
                    <div class="mb-3 input-group-sm">
                        ...
                        <input type="text" class="form-control border border-secondary" id="account" name="account" value="<?= $rowsCustomer["account"] ?>">
                    ...
                    <div class="mb-3 input-group-sm">
                        ...
                        <input type="text" class="form-control border border-secondary" id="name" name="name" value="<?= $rowsCustomer["name"] ?>">
                    </div>
                    <div class="mb-3 input-group-sm">
                        <label for="email" class="form-label">Email</label>
                        <input type="text" class="form-control border border-secondary" id="email" name="email" value="<?= $rowsCustomer["email"] ?>">
                    ...
                    <div class="mb-3 input-group-sm">
                        ...
                        <input type="text" class="form-control border border-secondary" id="phone" name="phone" value="<?= $rowsCustomer["phone"] ?>">
                    </div>
                    <button class="btn btn-primary mt-3" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">送出</button>
                    <!-- Modal -->
